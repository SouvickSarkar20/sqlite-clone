    ...
    <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '2rem', width: '100%' }}>
      <header style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
        <div style={{ background: 'var(--primary)', padding: '0.75rem', borderRadius: '12px' }}>
          <Database color="#fff" size={28} />
        </div>
        <div>
          <h1 style={{ fontSize: '1.8rem', fontWeight: 700, letterSpacing: '-0.5px', marginBottom: '4px' }}>SQLite Clone</h1>
          <p style={{ color: 'var(--muted-foreground)' }}>Interactive Database Engine</p>
        </div>
      </header>
